...
const char* devicename = "Zulhafiz_People_Counter"; // sets MQTT topics and hostname for ArduinoOTA

const char* ssid = "biasalahhh";     //wi-fi netwrok name
const char* password = "zul12345";  //wi-fi network password
const char* mqtt_server = "broker.emqx.io";   // mqtt broker ip address (without port)
